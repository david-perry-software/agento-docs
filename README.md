<!-- agento-companion: david-perry-software/agento -->
# Agento delivery artifacts

Delivery artifacts for `david-perry-software/agento`, written by the Agento plugin: plans,
...
moved here from the product repository `david-perry-software/agento` by `/agento agento-init --migrate`.
...
`david-perry-software/agento` at the time of writing.
